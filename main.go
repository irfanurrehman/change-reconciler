...
import (
	...
	turbonomiciov1alpha1 "github.com/irfanurrehman/change-reconciler/api/v1alpha1"
	"github.com/irfanurrehman/change-reconciler/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "3d4b1d32.turbonomic.io",
	})
	if err != nil {
